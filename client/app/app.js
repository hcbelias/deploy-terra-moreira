...
angular.module('webapp', ['webapp.constants', 'ngCookies', 'ngResource', 'ngSanitize', 'ui.router', 'validation.match', 'ngMaterial', 'ngMessages']).config(function ($urlRouterProvider, $locationProvider, $mdThemingProvider) {
    ...
    $mdThemingProvider.theme('default').primaryPalette('grey').warnPalette('deep-orange').accentPalette('red');
});
...
angular.module("webapp").run(["$templateCache", function($templateCache) {$templateCache.put("app/main/main.html","<div class=\"image-background\"><img ng-src=\"{{$ctrl.image}}\" alt=\"Advocacia Terra Moreira\" class=\"md-card-image img-responsive content md-whiteframe-14dp\"/></div><md-toolbar class=\"content-divider\"><md-toolbar-tools><span class=\"md-headline\"> </span></md-toolbar-tools></md-toolbar><md-card class=\"content card md-whiteframe-15dp\"><md-toolbar><md-toolbar-tools><span class=\"md-headline\">Quem Somos</span></md-toolbar-tools></md-toolbar><div layout=\"row\" class=\"degrade\"></div><md-card-content><p>O escritório Terra Moreira Sociedade de Advogados está inscrito na OAB/MG sob o número 5.536, sendo um escritório completo que oferece apoio profissional experiente para indivíduos e empresas. Somos um escritório consolidado no mercado da advocacia, com atuação em diversas áreas do Direito.</p><p>O diferencial do escritório é a sua atuação personalizada e estreita relação com o cliente, oferecendo soluções rápidas, seguras e eficazes para os questionamentos apresentados, sempre pautando-se na ética profissional e absoluto sigilo nas negociações, sempre no interesse dos clientes.</p></md-card-content></md-card><md-card class=\"content card md-whiteframe-15dp\"><md-toolbar><md-toolbar-tools><span class=\"md-headline\">Valores e Missão</span></md-toolbar-tools></md-toolbar><div layout=\"row\" class=\"degrade\"></div><md-card-content><p>Procuramos construir uma banca de advocacia sólida, respeitada, moderna, eficiente e dinâmica, pautada em princípios de profissionalismo, lealdade, parceria, modernidade e pioneirismo.</p><p>Nosso maior foco é alcançar os resultados almejados por nossos clientes, sendo que o fruto de nosso sucesso deve-se ao planejamento, profissionais qualificados, trabalhando duro, entusiasmo e dedicação à causa.</p><p> \nAgradecemos imensamente a todos os clientes, amigos, parceiros e funcionários que de alguma forma nos ajudam a implementar nossos projetos.</p></md-card-content></md-card><md-card class=\"content card md-whiteframe-15dp\"><md-toolbar><md-toolbar-tools><span class=\"md-headline\">Contato </span></md-toolbar-tools></md-toolbar><div layout=\"row\" class=\"degrade\"></div><md-card-content><p>Procuramos construir uma banca de advocacia sólida, respeitada, moderna, eficiente e dinâmica, pautada em princípios de profissionalismo, lealdade, parceria, modernidade e pioneirismo.</p><p>Nosso maior foco é alcançar os resultados almejados por nossos clientes, sendo que o fruto de nosso sucesso deve-se ao planejamento, profissionais qualificados, trabalhando duro, entusiasmo e dedicação à causa.</p><p> \nAgradecemos imensamente a todos os clientes, amigos, parceiros e funcionários que de alguma forma nos ajudam a implementar nossos projetos.</p></md-card-content></md-card>");
